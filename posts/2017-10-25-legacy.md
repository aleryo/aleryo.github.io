...
Cette stratégie, facilitée par la conception modulaire du backend,
...
Même si le front-end reste encore aujourd'hui essentiellement une zone
sinistrée, nous n'avons pas baissé les bras. Un refactoring progressif
est probablement trop risqué et couteux mais nous travaillons déjà sur
une stratégie qui permettrait de faire croitre un deuxieme front-end à
coté de celui qui existe et qui pourrait le remplacer dans un horizon
qui pourrait etre plus proche que ce que l'histoire de l'application
pourrait nous laisser penser.
